    ...
    <section className="py-20 sm:py-24 md:py-28 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-[#6AAF08] hover:bg-[#5a9507] text-white font-bold text-lg px-12 py-5 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg"
        >
          <svg
            className="w-6 h-6"
            fill="currentColor"
